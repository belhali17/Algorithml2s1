...
year << ")" << endl;
    ...
    // Method to display car information (Encapsulation: public method accessingprivate data)
    void displayInfo() {
        cout << "Car Info: " << year << " " << make << " " << model << endl;
    }

private:
    // Private member variables: Encapsulation ensures these are hidden fromoutside access
    string make;
    string model;
    int year;
};
